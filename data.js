...
const RACE_DATA = {
  ...
  teams: [
    ...
    {
      id: "t2", name: "[队伍名 2]", rank: 2, bossHP: 24.7, phase: "P4", region: "NA", isLive: true,
      players: [
    ...
    {
      id: "t3", name: "[队伍名 3]", rank: 3, bossHP: 31.2, phase: "P3", region: "JP", isLive: true,
      players: [
    ...
    {
      id: "t8", name: "[队伍名 8]", rank: 8, bossHP: 92.9, phase: "P1", region: "EU", isLive: true,
      players: [
        { job: "DRK", role: "tank", stream: "#", streaming: true },
        { job: "WAR", role: "tank", stream: "#", streaming: true },
